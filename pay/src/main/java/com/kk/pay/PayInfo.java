...
public class PayInfo {
    ...
    private int is_h5_pay;
    private String remarks;


    private int is_override_url = 1;
    ...
    public int getIs_h5_pay() {
        return is_h5_pay;
    }

    public void setIs_h5_pay(int is_h5_pay) {
        this.is_h5_pay = is_h5_pay;
    }
    ...
    public int getIs_override_url() {
        return is_override_url;
    }

    public void setIs_override_url(int is_override_url) {
        this.is_override_url = is_override_url;
    }
}
