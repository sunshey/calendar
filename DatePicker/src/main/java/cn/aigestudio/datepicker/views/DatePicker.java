...
import cn.aigestudio.datepicker.bizs.themes.MyTheme;
...
public class DatePicker extends LinearLayout {
    ...
    public void setOnMonthChangedListener(DatePicker.onMonthChangedListener onMonthChangedListener) {
        this.onMonthChangedListener = onMonthChangedListener;
    }

    public void setOnYearChangedListener(DatePicker.onYearChangedListener onYearChangedListener) {
...
//        addView(rlTitle, llParams);
        ...
        for (int i = 0; i < mLManager.titleWeek().length; i++) {
            ...
            if (i == 0 || i == mLManager.titleWeek().length - 1) {
                tvWeek.setTextColor(0xFFD03F3F);
            }
        ...
        monthView.setOnDateChangeListener(new MonthView.OnDateChangeListener() {
            ...
            public void onMonthChange(int month) {
                ...
                if (onMonthChangedListener != null) {
                    onMonthChangedListener.onMonthChanged(month);
                }
                Log.e("TAG", month + "");
            }
            ...
            public void onYearChange(int year) {
                ...
                if (onYearChangedListener != null) {
                    onYearChangedListener.onYearChanged(year);
                }
            }
        });
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (Math.abs(ev.getX() - startX) > touchSlop) {
